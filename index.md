...
The discipline of computer science including [problem solving](https://en.wikipedia.org/wiki/Problem_solving#Computer_science), [algorithm development](https://en.wikipedia.org/wiki/Algorithm#Design), good programming style, [control flow](https://en.wikipedia.org/wiki/Control_flow), [I/O]((https://en.wikipedia.org/wiki/Input/output#Higher-level_implementation)) and elementary [data structures](https://en.wikipedia.org/wiki/Data_structure). Concepts implemented with extensive programming experience in [C++](https://www.stroustrup.com/C++.html), and a group programming project.
